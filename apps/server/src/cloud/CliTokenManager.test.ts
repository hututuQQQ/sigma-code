...
const TEST_ENV = {
  SIGMACODE_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  SIGMACODE_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  SIGMACODE_HOSTED_APP_URL: "https://hosted.example.test",
};
