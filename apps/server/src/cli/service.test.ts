...
const status = {
  ...
  logPath: "/home/me/.sigma/code/userdata/logs/boot-service.log",
} as const;
...
it("reports the installed service version and host paths", () => {
  assert.equal(
    ...
    [
      "Sigma Code service",
      "  Status: installed · Sigma Code 0.0.29",
      "  Unit: /home/me/.config/systemd/user/sigmacode.service",
      "  Logs: /home/me/.sigma/code/userdata/logs/boot-service.log",
    ].join("\n"),
  );
});
