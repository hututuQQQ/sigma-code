          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  SIGMACODE_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(
                    /^Bearer\s+/,
                    "",
                  ),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.sigma-code.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.sigma-code.bearer_token_env_var="SIGMACODE_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
