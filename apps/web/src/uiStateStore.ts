...
export const PERSISTED_STATE_KEY = "sigmacode:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "sigmacode:renderer-state:v8",
  "sigmacode:renderer-state:v7",
  "sigmacode:renderer-state:v6",
  "sigmacode:renderer-state:v5",
  "sigmacode:renderer-state:v4",
  "sigmacode:renderer-state:v3",
