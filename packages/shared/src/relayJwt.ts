...
export const RELAY_LINK_PROOF_TYP = "sigmacode-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "t3-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "t3-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "sigmacode-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "sigmacode-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "sigmacode-env-activity+jwt";
